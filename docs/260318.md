...
You may insert the lines below into the page header so the file will display normally. 

- It works on the site but not if you open a file on your device. 
- You still won't see images. 
- If you need to, you can change links to them to absolute.
